...
#define IST_GMT_OFFSET_SECS 19800   // UTC+5:30 = 5*3600 + 30*60
#define IST_GMT_OFFSET_SECS_DST 0  // India does not observe DST

#define GMT_OFFSET_SECS IST_GMT_OFFSET_SECS
#define GMT_OFFSET_SECS_DST IST_GMT_OFFSET_SECS_DST
    ...
    switch(azure_iot_get_status(&azure_iot))
    {
      case azure_iot_connected:
        ...
        else if (azure_pnp_send_telemetry(&azure_iot) != 0)
        {
          ...
          // Flashing Status Led when Data is sent
